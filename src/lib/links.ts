...
export const menuNavLinks: Record<string, Array<{ title: string; list: List }>> = {
	'/dashboard': [
		...
		// 			href: '/docs/themes',
		// 			label: 'Themes',
		// 			keywords: 'theme, customize, fonts, gradient, background'
		// 		},
		// 		{ href: '/docs/colors', label: 'Colors', keywords: 'theme, colors, swatches' },
		// 		{
		// 			href: '/docs/styling',
		// 			label: 'Styling',
		// 			keywords: 'styles, styling, props, classes, class, css'
		// 		},
		// 		{
		// 			href: '/docs/tokens',
		// 			label: 'Design Tokens',
		// 			keywords: 'theme, color, pairing, css, utility'
		// 		},
		// 		{
		// 			href: '/docs/variants',
		// 			label: 'Variants',
		...
		// 			label: 'Transitions',
		// 			keywords:
		// 				'transition, transitions, blur, fade, fly, slide, scale, draw, crossfade, prefers, reduced, motion'
		// 		},
		// 		{
		// 			href: '/docs/dark-mode',
		// 			label: 'Dark Mode',
		...
		// 				keywords: 'create, custom, style, css, design'
		// 			},
		// 			{
		// 				href: '/docs/figma',
		// 				label: 'Figma',
		// 				keywords: 'figma, design, mock, wireframe, ui, kit'
		// 			},
	...
	'/elements': [
		...
		// 				href: '/elements/cards',
		// 				label: 'Cards',
		// 				keywords: 'header, footer, background, cell, region'
		// 			},
		// 			{
		// 				href: '/elements/chips',
		// 				label: 'Chips',
		...
		// 			},
		// 			{
		// 				href: '/elements/logo-clouds',
		// 				label: 'Logo Clouds',
		// 				keywords: 'logo, brand, branding, links'
		// 			},
		// 			{
		...
		// 			{
		// 				href: '/elements/gradient-headings',
	...
	// 			},
	// 			{
	// 				href: '/components/listboxes',
	// 				label: 'Listboxes',
	// 				keywords: 'list, select, multi, multiple'
	// 			},
	// 			{
	// 				href: '/components/paginators',
	// 				label: 'Paginators',
	// 				keywords: 'nav, navigation, table, data, list'
	// 			},
	// 			{
	...
	// 				label: 'Ratings',
	// 				keywords: 'rating, rate, ratings, bar, star'
	// 			},
	// 			{
	// 				href: '/components/radio-groups',
	// 				label: 'Radio Groups',
	// 				keywords: 'input, form, select, selection'
	// 			},
	// 			{
	...
	// 				label: 'Code Blocks',
	// 				keywords: 'highlight, syntax, code'
	// 			},
	// 			{
	// 				href: '/utilities/drawers',
	// 				label: 'Drawers',
	// 				keywords: 'overlay, slide, panel, sidebar'
	// 			},
	// 			{
	// 				href: '/utilities/modals',
	// 				label: 'Modals',
	// 				keywords:
	// 					'overlay, dialog, notification, alert, confirm, prompt, multiple, form, list, embed, video'
	// 			},
	// 			{
	// 				href: '/utilities/popups',
	// 				label: 'Popups',
	// 				keywords: 'menu, tooltip, overlay, dropdown, combobox, drop, down, select'
	// 			},
	// 			{
	// 				href: '/utilities/toasts',
	// 				label: 'Toasts',
	// 				keywords: 'overlay, snack, snackbar, bar, action, alert, notification'
	// 			},
	// 			{
