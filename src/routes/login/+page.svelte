<div class="flex flex-col items-center h-full w-full pt-12  ">
	...
	<div class="bg-white py-6 shadow-md rounded-lg w-full max-w-sm mt-6 text-black">
		<form method="POST" action="?/login" class="flex flex-col items-center space-y-2 w-full">
			...
			<div class="w-full max-w-xs pt-3 flex justify-center items-center">
				<button class="btn btn-xs bg-gradient-to-br variant-gradient-tertiary-secondary w-44  ">Login</button>
			</div>
		</form>
	</div>
</div>
